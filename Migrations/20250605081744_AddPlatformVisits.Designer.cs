...
namespace Artportable.API.Migrations
{
    ...
    [Migration("20250605081744_AddPlatformVisits")]
    partial class AddPlatformVisits
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Artportable.API.Entities.Models.Artwork", b =>
                {
                    ...
                    b.Property<DateTime?>("BoostedEndDate")
                        .HasColumnType("datetime2")
                        .HasColumnName("boosted_end_date");
                    ...
                    b.Property<bool?>("FrameIncluded")
                        .HasColumnType("bit")
                        .HasColumnName("frame_included");
                    ...
                    b.Property<string>("SignedByArtist")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("signed_by_artist");
                    ...
                    b.Property<bool?>("isAaf")
                        .HasColumnType("bit")
                        .HasColumnName("is_aaf");
            ...
            modelBuilder.Entity("Artportable.API.Entities.Models.ArtworkView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_artwork_views");

                    b.ToTable("artwork_views");
                });
            ...
            modelBuilder.Entity("Artportable.API.Entities.Models.PlatformVisit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_platform_visits");

                    b.ToTable("platform_visits");
                });
            ...
            modelBuilder.Entity("Artportable.API.Entities.Models.ProfileView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Artportable.API.Entities.Models.User", b =>
                {
                    ...
                    b.Property<bool>("EmailAcceptedUppload")
                        .HasColumnType("bit")
                        .HasColumnName("email_accepted_uppload");
