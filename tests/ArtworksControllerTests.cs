...
namespace Artportable.ImageApi.Tests
{
    public class ArtworksControllerTests
    {
        ...
        {
            _artworksServiceMock
                .Setup(x => x.Get(It.IsAny<string>(), It.IsAny<string>()))
                .Returns(new List<ArtworkDTO>());
            //Arrange
            var artworksController = new ArtworksController(
                _artworksServiceMock.Object,
            ...
            objectResult
                .Value.As<List<ArtworkDTO>>()
                .Should()
                .BeEmpty("moq setup was configured to return a empty result");
            objectResult
                .StatusCode.Should()
                .Be((int)HttpStatusCode.OK, "expected result to be successful");
        }
        ...
        public void GetArtworksExceptionTest(string owner, string myUsername)
        {
            ...
            objectResult
                .StatusCode.Should()
                .Be((int)HttpStatusCode.InternalServerError, "expected result to be unsuccessful");
        }
        ...
        public void GetArtworkTest(Guid id, string myUsername)
        {
            ...
            _artworksServiceMock
                .Setup(x => x.Get(It.IsAny<Guid>(), It.IsAny<string>()))
                .Returns(expected);
            //Arrange
            var artworksController = new ArtworksController(
                _artworksServiceMock.Object,
            ...
            objectResult
                ...
                .And.BeEquivalentTo(
                    expected,
                    "no there should not be any changes to the expected object"
                );
            objectResult
                .StatusCode.Should()
                .Be((int)HttpStatusCode.OK, "expected result to be successful");
        ...
        public void GetArtworkNotFoundTest(Guid id, string myUsername)
        {
            ...
            objectResult
                .StatusCode.Should()
                .Be((int)HttpStatusCode.NotFound, "expected result to be not found");
        }
        ...
        public async void CreateArtworkTest(ArtworkForCreationDTO artwork, Guid mySocialId)
        {
            var expected = new ArtworkDTO()
            {
                ...
                PrimaryFile = new FileDTO() { Name = artwork.PrimaryFile },
                SecondaryFile = string.IsNullOrWhiteSpace(artwork.SecondaryFile)
                    ? null
                    : new FileDTO() { Name = artwork.SecondaryFile },
                TertiaryFile = string.IsNullOrWhiteSpace(artwork.TertiaryFile)
                    ? null
                    : new FileDTO() { Name = artwork.TertiaryFile },
                LikedByMe = false,
                Likes = 0,
                Owner = new OwnerDTO()
                {
            ...
            _artworksServiceMock
                .Setup(x => x.Create(It.IsAny<ArtworkForCreationDTO>(), It.IsAny<Guid>()))
                .Returns(expected);
            //Arrange
            var artworksController = new ArtworksController(
                _artworksServiceMock.Object,
        ...
        [Theory]
        [ClassData(typeof(CreateArtWorkCases))]
        public async void CreateArtworkBadRequestTest(
            ArtworkForCreationDTO artwork,
            Guid mySocialId
        )
        {
            _artworksServiceMock
            ...
            objectResult
                .StatusCode.Should()
                .Be((int)HttpStatusCode.BadRequest, "expected result to be bad request");
        }
        ...
        public async void UpdateArtworkTest(ArtworkForUpdateDTO artwork, Guid id, Guid mySocialId)
        {
            ...
            _artworksServiceMock
                .Setup(x =>
                    x.Update(It.IsAny<ArtworkForUpdateDTO>(), It.IsAny<Guid>(), It.IsAny<Guid>())
                )
                .Returns(expected);
            //Arrange
            var artworksController = new ArtworksController(
        ...
        [Theory]
        [ClassData(typeof(UpdateArtWorkCases))]
        public async void UpdateArtworkNotFoundTest(
            ArtworkForUpdateDTO artwork,
            Guid id,
            Guid mySocialId
        )
        {
        ...
        [Theory]
        [ClassData(typeof(UpdateArtWorkCases))]
        public async void UpdateArtworkExceptionTest(
            ArtworkForUpdateDTO artwork,
            Guid id,
            Guid mySocialId
        )
        ...
        {
            var expected = new List<TagDTO>() { new TagDTO() { Tag = "test" } };
        ...
        {
            _artworksServiceMock
                .Setup(x => x.GetTags(It.IsAny<Guid>()))
        ...
        public void LikeArtworkTest()
        {
            ...
            _artworksServiceMock
                .Setup(x => x.Like(It.IsAny<Guid>(), It.IsAny<Guid>(), out randomString))
                .Returns(true);
            //Arrange
            var artworksController = new ArtworksController(
                _artworksServiceMock.Object,
        ...
        public void UnlikeArtworkTest()
        {
            ...
            Guid randomString;
            _artworksServiceMock
                .Setup(x => x.Unlike(It.IsAny<Guid>(), It.IsAny<Guid>(), out randomString))
                .Returns(true);
            var artworksController = new ArtworksController(
                _artworksServiceMock.Object,
                _activityServiceMock.Object
