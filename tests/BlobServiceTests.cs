...
namespace Artportable.ImageApi.Tests
{
  public class BlobServiceTests
  {
    ...
    public async void UploadAsyncInvalidTestStreamTest()
    {
      ...
      //Assert
      await act.Should().ThrowAsync<ArgumentException>("null or empty file TestStream is not a valid parameter");
    }
    ...
    public async void UploadAsyncBlobExceptionTest()
    {
      ...
      //Act
      Func<Task> act = blobService.Awaiting(x => x.UploadAsync((TestStream)TestStream, "filename"));
