...
namespace Artportable.API.Services
{
  public class DiscoverService : IDiscoverService
  {
    ...
    public List<ArtworkDTO> GetLikedByMeArtworks (int page, int pageSize, List<string> tags, string myUsername, DateTime likesSince, ProductEnum minimumProduct = ProductEnum.Portfolio){
      return _context.Artworks
        .Where(a => tags.Count != 0 ? a.Tags.Any(t => tags.Contains(t.Title)) : true)
    ...
    public List<ArtworkDTO> GetLikedByMeArtworksSold (int page, int pageSize, List<string> tags, string myUsername, DateTime likesSince, ProductEnum minimumProduct = ProductEnum.Portfolio){
      return _context.Artworks
        .Where(a => tags.Count != 0 ? a.Tags.Any(t => tags.Contains(t.Title)) : true)
        .Where(a => a.Likes.Any(l => l.User.Username == myUsername))
        .Where(x => x.SoldOut == true)
    ...
    public List<ArtworkDTO> GetLikedByMeArtworksUnsold (int page, int pageSize, List<string> tags, string myUsername, DateTime likesSince, ProductEnum minimumProduct = ProductEnum.Portfolio){
      return _context.Artworks
        .Where(a => tags.Count != 0 ? a.Tags.Any(t => tags.Contains(t.Title)) : true)
        .Where(a => a.Likes.Any(l => l.User.Username == myUsername))
        .Where(x => x.SoldOut == false)
