...
namespace Artportable.API.Services
{
    public class ConnectionService : IConnectionService
    {
        ...
        public List<RecommendationDTO> GetRecommendations(string myUsername)
        {
            ...
            var usersIFollow = _context
                .Connections.Include(c => c.Followee)
            ...
            var tagIds = tagsUsedByArtistsIFollow
                .Union(tagsUsedByArtworksILike)
                .GroupBy(t => t.Id)
            ...
            var allUsersExceptUnRecommendable = _context.Users.Where(u =>
                !unRecommendableUsersId.Contains(u.Id)
            );
        ...
        public bool Follow(Guid socialId, Guid? mySocialId)
        {
            ...
            if (
                _context.Connections.Any(c =>
                    c.FollowerId == (int)myId && c.FolloweeId == (int)followeeId
                )
            )
            {
                return true;
            ...
            _context.Connections.Add(
                new Connection { FollowerId = (int)myId, FolloweeId = (int)followeeId }
            );
