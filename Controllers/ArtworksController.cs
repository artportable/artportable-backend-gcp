...
namespace Artportable.API.Controllers
{
    ...
    public class ArtworksController : ControllerBase
    {
        ...
        public async Task<ActionResult<ArtworkDTO>> CreateArtwork(
            [FromBody] ArtworkForCreationDTO dto,
            Guid mySocialId
        )
        {
            try
        ...
        [SwaggerResponse(StatusCodes.Status200OK, Type = typeof(ArtworkDTO))]
        [SwaggerResponse(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<ArtworkDTO>> UpdateArtwork(
            [FromBody] ArtworkForUpdateDTO dto,
            Guid id,
            Guid mySocialId
        )
        {
        ...
        [SwaggerResponse(StatusCodes.Status200OK, Type = typeof(List<ArtworkDTO>))]
        public ActionResult<List<ArtworkDTO>> UpdateArtworksOrderIndices(
            [FromBody] List<ArtworkOrderIndexUpdate> updateOrderIndexDtos
        )
        {
            try
            {
                ...
                {
                    var updatedArtwork = _artworkService.UpdateOrderIndex(
                        updateOrderIndexDto.ArtworkId,
                        updateOrderIndexDto.OrderIndex
                    );
                }
        ...
        [SwaggerResponse(StatusCodes.Status200OK, Type = typeof(ArtworkDTO))]
        [SwaggerResponse(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<ArtworkDTO>> PromoteArtwork(
            [FromBody] ArtworkForPromotionDTO dto,
            Guid id,
            Guid mySocialId
        )
        {
