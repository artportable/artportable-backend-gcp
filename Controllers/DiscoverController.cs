  ...
  public class DiscoverController : ControllerBase
  {
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetTrendingArtworks(page, pageSize, tags, myUsername, DateTime.Now.AddDays(likesSince), orientation, sizeFilter, priceFilter);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetDigitalArtworks(page, pageSize, tags, myUsername);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetLatestArtworksSold(page, pageSize, tags, myUsername);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetLatestArtworksUnsold(page, pageSize, tags, myUsername);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetLikedByMeArtworks(page, pageSize, tags, myUsername);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetLikedByMeArtworksSold(page, pageSize, tags, myUsername);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetLikedByMeArtworksUnsold(page, pageSize, tags, myUsername);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetPromotedArtworks(page, pageSize, seed.Value, tags, myUsername);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetAafArtworks(page, pageSize, seed.Value, tags, myUsername);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetBoostedArtworks(page, pageSize, seed.Value, tags, myUsername);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
    ...
    )
    {
      ...
      try
      {
        ...
        if (string.IsNullOrWhiteSpace(q))
        {
          artworks = _discoverService.GetFilteredArtworks(page, pageSize, tags, myUsername, DateTime.Now.AddDays(likesSince), orientation, sizeFilter, priceFilter, stateFilter);
        }
        else
        {
          artworks = _searchService.SearchArtworks(page, pageSize, myUsername, q, tags);
