...
namespace Artportable.API.Entities
{
    public class APContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure columns
            modelBuilder.Entity<Image>().Property(i => i.Id).HasColumnType("varchar(36)").IsRequired();
            modelBuilder.Entity<Image>().Property(i => i.Title).HasColumnType("varchar(150)");
            modelBuilder.Entity<Image>().Property(i => i.FileName).HasColumnType("varchar(200)");
            modelBuilder.Entity<Image>().Property(i => i.OwnerId).HasColumnType("varchar(50)");

            modelBuilder.Entity<User>().Property(i => i.Id).HasColumnType("varchar(36)").IsRequired();
            modelBuilder.Entity<User>().Property(i => i.Username).HasColumnType("varchar(150)");
            modelBuilder.Entity<User>().Property(i => i.Email).HasColumnType("varchar(200)");
            modelBuilder.Entity<User>().Property(i => i.Profilepicture).HasColumnType("varchar(150)");
